...
int usage(char *prog){
    printf("Usage is %s <file_out> <file_out> <a coeff>\n", prog);
    printf("\n");
    printf("apply the e2 filter to the file specified above\n");
    printf("With the a coeff parameter specified above.\n");
    return 0;
}
...
int main(int argc, char **argv){
    ...
    printf("Applying e2 filter with a=%f\n", a);
    resp = e2filter(y, x, a, n);
    if(resp != 0){
